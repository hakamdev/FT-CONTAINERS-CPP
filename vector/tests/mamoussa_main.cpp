...
/*   Updated: 2022/07/24 03:39:18 by ehakam           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define TIME_FAC 1 // the ft::vector methods can be slower up to std::vector methods * TIME_FAC (MAX 20)
...
void reverse_iterator_tests(void)
{
    ...
    /*----------------------------------*/
    /*------------ ft::reverse_iterator ---------*/
    ft::rracc_iterator<std::vector<int>::iterator> my_rit(v.end()), my_rit1(v.end() - 1);
    /*----------------------------------*/
    
    std::cout << "\033[1;37m[-------------------- [" << std::setw(40) << std::left << " copy constructor "
              << "] --------------------]\t\t\033[0m";
    {
        ft::rracc_iterator<std::vector<int>::iterator> ob(my_rit);
        EQUAL(&(*my_rit) == &(*ob));
    }
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::rracc_iterator<std::vector<std::string>::iterator> my_rit(v.end());
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::rracc_iterator<std::vector<int>::iterator> my_tmp(my_rit++);
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::rracc_iterator<std::vector<char>::iterator> my_start(v.end()), my_end(v.begin());
